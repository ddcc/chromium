...
const base::Feature __attribute__((no_destroy)) kGenericSensorExtraClasses{
...
const base::Feature __attribute__((no_destroy)) kWinrtSensorsImplementation{
...
const base::Feature __attribute__((no_destroy)) kWinrtGeolocationImplementation{
...
// WiFi scans.
const base::Feature __attribute__((no_destroy)) kMacCoreLocationImplementation{
    "MacCoreLocationImplementation", base::FEATURE_ENABLED_BY_DEFAULT};
const base::Feature __attribute__((no_destroy)) kMacCoreLocationBackend{"MacCoreLocationBackend",
...
const base::Feature __attribute__((no_destroy)) kUseSerialBusEnumerator{"UseSerialBusEnumerator",
