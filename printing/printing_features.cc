...
const base::Feature __attribute__((no_destroy)) kAdvancedPpdAttributes{"AdvancedPpdAttributes",
...
const base::Feature __attribute__((no_destroy)) kCupsIppPrintingBackend{"CupsIppPrintingBackend",
                                            base::FEATURE_DISABLED_BY_DEFAULT};
#endif  // defined(OS_MAC)

#if defined(OS_WIN)
// When using GDI printing, avoid rasterization if possible.
const base::Feature __attribute__((no_destroy)) kPrintWithReducedRasterization{
    "PrintWithReducedRasterization", base::FEATURE_DISABLED_BY_DEFAULT};

// Use XPS for printing instead of GDI.
const base::Feature __attribute__((no_destroy)) kUseXpsForPrinting{"UseXpsForPrinting",
                                       base::FEATURE_DISABLED_BY_DEFAULT};
...
const base::Feature __attribute__((no_destroy)) kUseXpsForPrintingFromPdf{
...
// out-of-process.
const base::Feature __attribute__((no_destroy)) kEnableOopPrintDrivers{"EnableOopPrintDrivers",
                                           base::FEATURE_DISABLED_BY_DEFAULT};
