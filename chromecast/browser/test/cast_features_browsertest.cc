...
const base::Feature __attribute__((no_destroy)) kTestFeat1{"test_feat_1",
                               base::FEATURE_DISABLED_BY_DEFAULT};
const base::Feature __attribute__((no_destroy)) kTestFeat2{"test_feat_2", base::FEATURE_ENABLED_BY_DEFAULT};
const base::Feature __attribute__((no_destroy)) kTestFeat3{"test_feat_3",
                               base::FEATURE_DISABLED_BY_DEFAULT};
const base::Feature __attribute__((no_destroy)) kTestFeat4{"test_feat_4", base::FEATURE_ENABLED_BY_DEFAULT};

// For use in TestParamsActivateOnBoot only.
const base::Feature __attribute__((no_destroy)) kTestFeat11{"test_feat_11",
                                base::FEATURE_DISABLED_BY_DEFAULT};

// For use in TestOnlyWellFormedFeaturesPersisted only.
const base::Feature __attribute__((no_destroy)) kTestFeat21{"test_feat_21",
                                base::FEATURE_DISABLED_BY_DEFAULT};
const base::Feature __attribute__((no_destroy)) kTestFeat22{"test_feat_22",
                                base::FEATURE_ENABLED_BY_DEFAULT};
const base::Feature __attribute__((no_destroy)) kTestFeat23{"test_feat_23",
                                base::FEATURE_DISABLED_BY_DEFAULT};
const base::Feature __attribute__((no_destroy)) kTestFeat24{"test_feat_24",
                                base::FEATURE_ENABLED_BY_DEFAULT};
