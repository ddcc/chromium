...
const base::Feature __attribute__((no_destroy)) kAutofillAddressEnhancementVotes{
...
const base::Feature __attribute__((no_destroy)) kAutofillAllowDuplicateFormSubmissions{
...
// country.
const base::Feature __attribute__((no_destroy)) kAutofillAllowHtmlTypeCountryCodesWithFullNames{
...
const base::Feature __attribute__((no_destroy)) kAutofillAllowNonHttpActivation{
    "AutofillAllowNonHttpActivation", base::FEATURE_DISABLED_BY_DEFAULT};

const base::Feature __attribute__((no_destroy)) kAutofillAlwaysFillAddresses{
...
// responses.
const base::Feature __attribute__((no_destroy)) kAutofillCacheQueryResponses{
    "AutofillCacheQueryResponses", base::FEATURE_ENABLED_BY_DEFAULT};

const base::Feature __attribute__((no_destroy)) kAutofillCreateDataForTest{
...
const base::Feature __attribute__((no_destroy)) kAutofillEnableAccountWalletStorage {
...
// when enabled.
const base::Feature __attribute__((no_destroy)) kAutofillEnableAugmentedPhoneCountryCode{
    "AutofillEnableAugmentedPhoneCountryCode",
    base::FEATURE_DISABLED_BY_DEFAULT};

// Controls whether we show "Hide suggestions" item in the suggestions menu.
const base::Feature __attribute__((no_destroy)) kAutofillEnableHideSuggestionsUI{
...
const base::Feature __attribute__((no_destroy)) kAutofillEnableSupportForMoreStructureInNames{
    "AutofillEnableSupportForMoreStructureInNames",
    base::FEATURE_DISABLED_BY_DEFAULT};

// Controls if Autofill supports new structure in addresses.
// TODO(crbug.com/1098943): Remove once launched.
const base::Feature __attribute__((no_destroy)) kAutofillEnableSupportForMoreStructureInAddresses{
    "AutofillEnableSupportForMoreStructureInAddresses",
    base::FEATURE_DISABLED_BY_DEFAULT};

// Controls if Autofill supports merging subset names.
// TODO(crbug.com/1098943): Remove once launched.
const base::Feature __attribute__((no_destroy)) kAutofillEnableSupportForMergingSubsetNames{
...
const base::Feature __attribute__((no_destroy)) kAutofillEnforceMinRequiredFieldsForHeuristics{
    "AutofillEnforceMinRequiredFieldsForHeuristics",
    base::FEATURE_ENABLED_BY_DEFAULT};

// Controls whether or not a minimum number of fields is required before
// crowd-sourced field type predictions are queried for a form.
const base::Feature __attribute__((no_destroy)) kAutofillEnforceMinRequiredFieldsForQuery{
    "AutofillEnforceMinRequiredFieldsForQuery",
    base::FEATURE_DISABLED_BY_DEFAULT};

// Controls whether or not a minimum number of fields is required before
// field type votes are uploaded to the crowd-sourcing server.
const base::Feature __attribute__((no_destroy)) kAutofillEnforceMinRequiredFieldsForUpload{
...
const base::Feature __attribute__((no_destroy)) kAutofillExtractAllDatalists{
...
const base::Feature __attribute__((no_destroy)) kAutofillFixFillableFieldTypes{
...
const base::Feature __attribute__((no_destroy)) kAutofillImportPrefilledCountryAndStateValues{
...
const base::Feature __attribute__((no_destroy)) kAutofillKeepInitialFormValuesInCache{
...
const base::Feature __attribute__((no_destroy)) kAutofillRetrieveFromCacheWithRendererIds{
...
const base::Feature __attribute__((no_destroy)) kAutofillRetrieveFromCacheWithFieldSignatureAsFallback{
    "AutofillRetrieveFromCacheWithFieldSignatureAsFallback",
    base::FEATURE_DISABLED_BY_DEFAULT};

// When enabled, autofill suggestions are displayed in the keyboard accessory
// instead of the regular popup.
const base::Feature __attribute__((no_destroy)) kAutofillKeyboardAccessory{
...
extern const base::Feature __attribute__((no_destroy)) kAutofillLabelAffixRemoval{
    "AutofillLabelAffixRemoval", base::FEATURE_DISABLED_BY_DEFAULT};

const base::Feature __attribute__((no_destroy)) kAutofillPruneSuggestions{
    "AutofillPruneSuggestions", base::FEATURE_DISABLED_BY_DEFAULT};

const base::Feature __attribute__((no_destroy)) kAutofillMetadataUploads{"AutofillMetadataUploads",
                                             base::FEATURE_DISABLED_BY_DEFAULT};

const base::Feature __attribute__((no_destroy)) kAutofillOffNoServerData{"AutofillOffNoServerData",
                                             base::FEATURE_DISABLED_BY_DEFAULT};

// If feature is enabled, autofill will be disabled for mixed forms (forms on
// HTTPS sites that submit over HTTP).
const base::Feature __attribute__((no_destroy)) kAutofillPreventMixedFormsFilling{
...
const base::Feature __attribute__((no_destroy)) kAutofillProbableFormSubmissionInBrowser{
    "AutofillProbableFormSubmissionInBrowser",
    base::FEATURE_DISABLED_BY_DEFAULT};

const base::Feature __attribute__((no_destroy)) kAutofillProfileClientValidation{
    "AutofillProfileClientValidation", base::FEATURE_DISABLED_BY_DEFAULT};

const base::Feature __attribute__((no_destroy)) kAutofillProfileImportFromUnifiedSection{
    "AutofillProfileImportFromUnifiedSection",
    base::FEATURE_DISABLED_BY_DEFAULT};

// TODO(crbug.com/1101280): Remove once feature is tested.
const base::Feature __attribute__((no_destroy)) kAutofillProfileImportFromUnfocusableFields{
...
const base::Feature __attribute__((no_destroy)) kAutofillProfileServerValidation{
...
const base::Feature __attribute__((no_destroy)) kAutofillRestrictUnownedFieldsToFormlessCheckout{
...
const base::Feature __attribute__((no_destroy)) kAutofillRichMetadataQueries{
...
const base::Feature __attribute__((no_destroy)) kAutofillSaveAndFillVPA{"AutofillSaveAndFillVPA",
                                            base::FEATURE_DISABLED_BY_DEFAULT};
...
const base::Feature __attribute__((no_destroy)) kAutofillSectionUponRedundantNameInfo{
...
const base::Feature __attribute__((no_destroy)) kAutofillServerCommunication{
    "AutofillServerCommunication", base::FEATURE_ENABLED_BY_DEFAULT};

// Controls attaching the autofill type predictions to their respective
// element in the DOM.
const base::Feature __attribute__((no_destroy)) kAutofillShowTypePredictions{
...
const base::Feature __attribute__((no_destroy)) kAutofillSkipComparingInferredLabels{
...
// initially value.
const base::Feature __attribute__((no_destroy)) kAutofillSkipFillingFieldsWithChangedValues{
...
const base::Feature __attribute__((no_destroy)) kAutofillTokenPrefixMatching{
    "AutofillTokenPrefixMatching", base::FEATURE_DISABLED_BY_DEFAULT};

// Enables the touch to fill feature for Android.
const base::Feature __attribute__((no_destroy)) kAutofillTouchToFill = {"TouchToFillAndroid",
                                            base::FEATURE_ENABLED_BY_DEFAULT};

// Autofill upload throttling is used for testing.
const base::Feature __attribute__((no_destroy)) kAutofillUploadThrottling{"AutofillUploadThrottling",
                                              base::FEATURE_ENABLED_BY_DEFAULT};

// Controls whether suggestions' labels use the improved label disambiguation
// format.
const base::Feature __attribute__((no_destroy)) kAutofillUseImprovedLabelDisambiguation{
...
const base::Feature __attribute__((no_destroy)) kAutofillUseNewSectioningMethod{
...
const base::Feature __attribute__((no_destroy)) kAutofillUsePageLanguageToTranslateCountryNames{
...
const base::Feature __attribute__((no_destroy)) kAutofillUseParseCityStateCountryZipCodeInHeuristic{
...
const base::Feature __attribute__((no_destroy)) kAutofillUseVariationCountryCode{
    "AutofillUseVariationCountryCode", base::FEATURE_DISABLED_BY_DEFAULT};

#if defined(OS_ANDROID)
// Controls whether the Autofill manual fallback for Addresses and Payments is
// present on Android.
const base::Feature __attribute__((no_destroy)) kAutofillManualFallbackAndroid{
...
const base::Feature __attribute__((no_destroy)) kAutofillRefreshStyleAndroid{
    "AutofillRefreshStyleAndroid", base::FEATURE_DISABLED_BY_DEFAULT};

#endif  // OS_ANDROID

#if defined(OS_ANDROID) || defined(OS_IOS)
const base::Feature __attribute__((no_destroy)) kAutofillUseMobileLabelDisambiguation{
...
const base::Feature __attribute__((no_destroy)) kAutofillUseUniqueRendererIDsOnIOS{
