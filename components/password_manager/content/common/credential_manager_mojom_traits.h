...
struct StructTraits<blink::mojom::CredentialInfoDataView,
  ...
  static const base::HQ_Optional<base::hq_string16> &id(
      const password_manager::CredentialInfo& r) {
    return r.id;
  }

  static const base::HQ_Optional<base::hq_string16> &name(
      const password_manager::CredentialInfo& r) {
    return r.name;
  }
  ...
  static const base::HQ_Optional<base::hq_string16> &password(
      const password_manager::CredentialInfo& r) {
    return r.password;
  }
