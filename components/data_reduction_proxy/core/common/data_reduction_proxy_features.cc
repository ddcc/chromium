...
const base::Feature __attribute__((no_destroy)) kDataReductionProxyLowMemoryDevicePromo{
    "DataReductionProxyLowMemoryDevicePromo",
    base::FEATURE_DISABLED_BY_DEFAULT};

// Enabled for Chrome dogfooders.
const base::Feature __attribute__((no_destroy)) kDogfood{"DataReductionProxyDogfood",
                             base::FEATURE_DISABLED_BY_DEFAULT};
...
const base::Feature __attribute__((no_destroy)) kDataReductionProxyHoldback{
...
const base::Feature __attribute__((no_destroy)) kDataReductionProxyServerExperiments{
...
const base::Feature __attribute__((no_destroy)) kDataReductionProxyAggressiveConfigFetch{
...
const base::Feature __attribute__((no_destroy)) kReportSaveDataSavings{"ReportSaveDataSavings",
                                           base::FEATURE_DISABLED_BY_DEFAULT};

// Enables fetching the Client Config for server-based Lite Mode features.
const base::Feature __attribute__((no_destroy)) kFetchClientConfig{"DataReductionProxyFetchClientConfig",
                                       base::FEATURE_ENABLED_BY_DEFAULT};
