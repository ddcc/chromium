...
// enabled.
const base::Feature __attribute__((no_destroy)) kAppRuntimePerormanceStatistics{
    "AppRuntimePerormanceStatistics", base::FEATURE_ENABLED_BY_DEFAULT};

// Controls ACTION_BOOT_COMPLETED broadcast for third party applications on ARC.
// When disabled, third party apps will not receive this broadcast.
const base::Feature __attribute__((no_destroy)) kBootCompletedBroadcastFeature {
...
const base::Feature __attribute__((no_destroy)) kCleanArcDataOnRegularToChildTransitionFeature{
    "ArcCleanDataOnRegularToChildTransition",
    base::FEATURE_DISABLED_BY_DEFAULT};

// Controls experimental Custom Tabs feature for ARC.
const base::Feature __attribute__((no_destroy)) kCustomTabsExperimentFeature{
    "ArcCustomTabsExperiment", base::FEATURE_ENABLED_BY_DEFAULT};

// Controls whether ARC applications support zoom in/out.
const base::Feature __attribute__((no_destroy)) kEnableApplicationZoomFeature{
...
const base::Feature __attribute__((no_destroy)) kEnableChildToRegularTransitionFeature{
...
// Chrome OS Files app.
const base::Feature __attribute__((no_destroy)) kEnableDocumentsProviderInFilesAppFeature{
...
const base::Feature __attribute__((no_destroy)) kEnableRegularToChildTransitionFeature{
...
const base::Feature __attribute__((no_destroy)) kEnableSecondaryAccountsForChild{
...
const base::Feature __attribute__((no_destroy)) kEnableUnifiedAudioFocusFeature{
    "ArcEnableUnifiedAudioFocus", base::FEATURE_ENABLED_BY_DEFAULT};

// Controls experimental file picker feature for ARC.
const base::Feature __attribute__((no_destroy)) kFilePickerExperimentFeature{
...
const base::Feature __attribute__((no_destroy)) kNativeBridge64BitSupportExperimentFeature{
...
const base::Feature __attribute__((no_destroy)) kNativeBridgeToggleFeature{
...
// will be disabled.
const base::Feature __attribute__((no_destroy)) kPictureInPictureFeature{"ArcPictureInPicture",
                                             base::FEATURE_ENABLED_BY_DEFAULT};

// Controls ARC USB host integration.
// When enabled, Android apps will be able to use usb host features.
const base::Feature __attribute__((no_destroy)) kUsbHostFeature{"ArcUsbHost",
                                    base::FEATURE_ENABLED_BY_DEFAULT};
...
const base::Feature __attribute__((no_destroy)) kUsbStorageUIFeature{"ArcUsbStorageUI",
                                         base::FEATURE_ENABLED_BY_DEFAULT};
...
const base::Feature __attribute__((no_destroy)) kVideoDecoder{"ArcVideoDecoder",
                                  base::FEATURE_DISABLED_BY_DEFAULT};
