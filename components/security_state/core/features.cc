...
const base::Feature __attribute__((no_destroy)) kMarkHttpAsFeature{"MarkHttpAs",
...
const base::Feature __attribute__((no_destroy)) kLegacyTLSWarnings{"LegacyTLSWarnings",
                                       base::FEATURE_DISABLED_BY_DEFAULT};

const base::Feature __attribute__((no_destroy)) kSafetyTipUI{"SafetyTip",
                                 base::FEATURE_DISABLED_BY_DEFAULT};
