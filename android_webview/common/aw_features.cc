...
const base::Feature __attribute__((no_destroy)) kWebViewBrotliSupport{"WebViewBrotliSupport",
...
const base::Feature __attribute__((no_destroy)) kWebViewConnectionlessSafeBrowsing{
...
// architectures.
const base::Feature __attribute__((no_destroy)) kWebViewCpuAffinityRestrictToLittleCores{
    "WebViewCpuAffinityRestrictToLittleCores",
    base::FEATURE_DISABLED_BY_DEFAULT};

// Enable display cutout support for Android P and above.
const base::Feature __attribute__((no_destroy)) kWebViewDisplayCutout{"WebViewDisplayCutout",
                                          base::FEATURE_DISABLED_BY_DEFAULT};
...
const base::Feature __attribute__((no_destroy)) kWebViewExtraHeadersSameDomainOnly{
...
const base::Feature __attribute__((no_destroy)) kWebViewExtraHeadersSameOriginOnly{
...
const base::Feature __attribute__((no_destroy)) kWebViewTestFeature{"WebViewTestFeature",
                                        base::FEATURE_DISABLED_BY_DEFAULT};

// Enable raster in wide color gamut for apps that use webview in a wide color
// gamut activity.
const base::Feature __attribute__((no_destroy)) kWebViewWideColorGamutSupport{
