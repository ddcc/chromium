...
// feature is disabled.
const base::Feature __attribute__((no_destroy)) kCustomizedTabLoadTimeout{
...
const base::Feature __attribute__((no_destroy)) kStaggeredBackgroundTabOpening{
...
const base::Feature __attribute__((no_destroy)) kStaggeredBackgroundTabOpeningExperiment{
...
const base::Feature __attribute__((no_destroy)) kTabRanker{"TabRanker", base::FEATURE_DISABLED_BY_DEFAULT};
