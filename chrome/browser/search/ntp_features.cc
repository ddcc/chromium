...
const base::Feature __attribute__((no_destroy)) kConfirmSuggestionRemovals{
...
const base::Feature __attribute__((no_destroy)) kDismissPromos{"DismissNtpPromos",
                                   base::FEATURE_DISABLED_BY_DEFAULT};

// If enabled, the OneGooleBar is loaded in an iframe. Otherwise, it is inlined.
const base::Feature __attribute__((no_destroy)) kIframeOneGoogleBar{"IframeOneGoogleBar",
                                        base::FEATURE_DISABLED_BY_DEFAULT};
...
const base::Feature __attribute__((no_destroy)) kNtpRepeatableQueries{"NtpRepeatableQueries",
                                          base::FEATURE_DISABLED_BY_DEFAULT};

// If enabled, the iframed OneGooleBar shows the overlays modally with a
// backdrop.
const base::Feature __attribute__((no_destroy)) kOneGoogleBarModalOverlays{
...
const base::Feature __attribute__((no_destroy)) kRealboxMatchOmniboxTheme{
...
const base::Feature __attribute__((no_destroy)) kRealboxUseGoogleGIcon{"NtpRealboxUseGoogleGIcon",
                                           base::FEATURE_DISABLED_BY_DEFAULT};
...
const base::Feature __attribute__((no_destroy)) kRealbox{"NtpRealbox", base::FEATURE_ENABLED_BY_DEFAULT};
...
const base::Feature __attribute__((no_destroy)) kSearchSuggestChips{"SearchSuggestChips",
                                        base::FEATURE_DISABLED_BY_DEFAULT};

// If enabled, hides Vasco suggestion chips in the NTP below fakebox/realbox
// despite other config.
const base::Feature __attribute__((no_destroy)) kDisableSearchSuggestChips{
...
const base::Feature __attribute__((no_destroy)) kWebUI{"NtpWebUI", base::FEATURE_DISABLED_BY_DEFAULT};

// If disabled, the realbox will not show on the WebUI new tab page.
const base::Feature __attribute__((no_destroy)) kWebUIRealbox{"WebUIRealbox",
                                  base::FEATURE_ENABLED_BY_DEFAULT};

// If enabled, the Doodle will be shown on themed and dark mode NTPs.
const base::Feature __attribute__((no_destroy)) kWebUIThemeModeDoodles{"WebUIThemeModeDoodles",
                                           base::FEATURE_ENABLED_BY_DEFAULT};

// If enabled, modules will be shown.
const base::Feature __attribute__((no_destroy)) kModules{"NtpModules", base::FEATURE_DISABLED_BY_DEFAULT};

// If enabled, shopping tasks module will be shown.
const base::Feature __attribute__((no_destroy)) kNtpShoppingTasksModule{"NtpShoppingTasksModule",
                                            base::FEATURE_DISABLED_BY_DEFAULT};
